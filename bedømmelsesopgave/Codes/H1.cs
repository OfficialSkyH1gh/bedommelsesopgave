...
namespace bedømmelsesopgave.Codes
{
    ...
    internal class H1
    {
        ...
        static List<Elever> GrundElever = new List<Elever>()
        {
        ...
        static List<Elever> DataElever = new List<Elever>()
        {
        ...
        static List<Elever> Studieteknik = new List<Elever>()
        {
        ...
        static List<EducationalProgram> _educationalPrograms = new List<EducationalProgram>()
        {
                new EducationalProgram(GrundElever, "Grundlæggende programmering", "Niels"),
                new EducationalProgram(DataElever, "Database elever", "Henrik"),
                new EducationalProgram(Studieteknik, "Studieteknik", "John")
        };
            ...
            //};
        public static List<EducationalProgram> GetList()
        {
            return _educationalPrograms;
        }
    }
}
